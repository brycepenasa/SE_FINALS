								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<div class="aa-product-view-content">
										...
										<div class="aa-price-block">
											<span class="aa-product-view-price">₱<%=resultSet.getString("price")%></span>
											<p class="aa-product-avilability">
												Availability: <span><%=resultSet.getString("qty")%> In
													stock</span>
											</p>
										</div>				
									</div>
...
%>
              ...
              <%    if(adminreply != null) {   %>
                <br><p><b>Seller's Response:</b><br> <%= adminreply %></p>
...
%>
							...
							<%
												try {
													...
													while (resultSet.next()) {
												%>		
	<form method="post" action="feedbackpage" class="aa-review-form" >
										<br><hr>
	...
	<input type="hidden" name="id" value="<%=resultSet.getString("id")%>">
											...
											<label for="to">Reply to:</label>
												<input type="text" class="form-control" id="to" name="userfeedback" required>
												<label for="message">Your Reply:</label>
												<textarea class="form-control" rows="3" id="message" name="reply" required></textarea>
											</div>
...
<input type="submit"
    ...
    if (status == "replySuccess"){
    	swal("Success!!", "Reply was sent","success");
    }
    else if (status == "replyFailed"){
    	swal("Failed", "User review not found", "error");
    }
