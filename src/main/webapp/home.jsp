...
<header>
	...
	<nav class="navbar">
		<ul>
			<li style="background:#FAB4BF;"><a href="home.jsp">HOME</a></li>
...
<div style="width: 100%; height:100%;"class="carousel slide" data-pause="false" data-ride="carousel" id="carousel">
            <div class="carousel-inner ">
              ...
              <div class="carousel-item"> <a href="loungewear.jsp"><img class="d-block img-fluid w-100" style="height: 835px;" src="images/ban.png"></a>
                <div class="carousel-caption">                 
                </div>
              </div>
