...
<header>
	...
	<nav class="navbar">
		<ul>
			...
			<li style="background:#FAB4BF;"><a href="loungewear.jsp">PRODUCTS</a></li>
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<div class="aa-product-view-content">
										...
										<div class="aa-price-block">
											<span class="aa-product-view-price" style="color:#f66f83; font-size: 25px; font-weight: bold;" >₱<%=resultSet.getString("price")%></span>
										...
										<div class="aa-prod-quantity">
											<form action="">
												<label for="quantity">Quantity:</label> <input type="number"
													...
													max="<%=resultSet.getString("qty")%>">
											</form>
										</div>
										<div class="aa-prod-view-bottom">
											<a class="aa-add-to-cart-btn" href="cart.jsp">Add To Cart</a>
